...
| ---: | --- | --- | --- |
| 1 | Diagnose my Surface | Run device diagnostics for battery drain on my Surface. | `RunDeviceDiagnostics` |
| 2 | Configure a device | Configure a Surface Laptop request with 32 GB memory and 512 GB storage. | `ConfigureDeviceRequest` |
