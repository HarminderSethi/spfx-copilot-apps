...
- Package and deploy the solution to your **App Catalog**, grant the API permissions noted under Prerequisites, then invoke the **AgentsExplorer Agent** in Microsoft Copilot
